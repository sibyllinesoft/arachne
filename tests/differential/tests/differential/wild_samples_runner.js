...
class WildSamplesRunner {
    ...
    async generateTestCases(config, samplesMetadata) {
        ...
        if (samplesMetadata.length > 0) {
            for (const [index, metadata] of samplesMetadata.entries()) {
                ...
                const testCase = {
                    name: `wild_${primaryTechnique}_${index, 3: d
                } `,
          description: `, Wild, sample, { primaryTechnique };
                ($);
                {
  ...
  private generateHtmlReport(jsonReport: any): string {
    ...
    return `
                ...
                "error" > Failed < /h3>
                    < div;
                style = "font-size: 2em; color: #f44336;" > $;
                {
                    stats.failed;
                }
                /div>
                ...
                Score < /h3>
                    < div;
                style = "font-size: 1.5em; color: #2196F3;" > $;
                {
                    (stats.robustnessScore * 100).toFixed(1);
                }
                 % /div>
                    < /div>
                    < /div>
                ...
                {
                    (stats.diversityScore * 100).toFixed(1);
                }
                 % /div>
                    < /div>
                    < div;
                ...
                style = "font-size: 1.5em;" > $;
                {
                    (stats.averageOptimizationGain * 100).toFixed(1);
                }
                 % /div>
                    < /div>
                    < div;
                ...
                Time < /h3>
                    < div > $;
                {
                    Math.round(stats.executionTimeMs);
                }
                ms < /div>
                    < /div>
                    < div;
                ...
                Memory < /h3>
                    < div > $;
                {
                    Math.round(stats.peakMemoryUsageMB);
                }
                MB < /div>
                    < /div>
                    < /div>
        ...
        `).join('');
                ...
                Data < /summary>
                    < pre;
                style = "background: #f5f5f5; padding: 20px; border-radius: 5px; overflow-x: auto;" >
                    $;
                {
  ...
  private printSummary(statistics: WildSampleStatistics): void {
    ...
    console.log(`;
                ...
                ($);
                {
                    (statistics.passed / Math.max(statistics.totalTests, 1) * 100).toFixed(1);
                }
                 % ;
                `);
    console.log(`;
    ...
    console.log(`;
                ...
                Score: $;
                {
                    (statistics.diversityScore * 100).toFixed(1);
                }
                 % `);
    console.log(`;
                Robustness;
                Score: $;
                {
                    (statistics.robustnessScore * 100).toFixed(1);
                }
                 % `);
    console.log(`;
                Avg;
                ...
                Gain: $;
                {
                    (statistics.averageOptimizationGain * 100).toFixed(1);
                }
                 % `);
    console.log('');
    console.log(`;
                ...
                Time: $;
                {
                    Math.round(statistics.executionTimeMs);
                }
                ms `);
    console.log(`;
                Peak;
                Memory: $;
                {
                    Math.round(statistics.peakMemoryUsageMB);
                }
                MB `);
    console.log('');
